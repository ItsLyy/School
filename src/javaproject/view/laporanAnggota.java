...
public class laporanAnggota extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jRadioButton2.isSelected()) {
            new ConfigDB().tampilLaporan("src\\javaproject\\report\\AnggotaReport.jrxml", "SELECT * FROM tb_anggota ORDER BY id_anggota ASC");
        } else {
            new ConfigDB().tampilLaporan("src/javaproject/report/AnggotaReport.jrxml", "SELECT * FROM tb_anggota WHERE id_anggota = '" + jTextField1.getText() + "'");
        }
